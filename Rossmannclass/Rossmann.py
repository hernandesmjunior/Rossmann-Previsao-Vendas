...
class Rossmann(object):
    ...
    def __init__(self):
        self.competition_distance_scaler      = pickle.load(open('/Users/herna/repos/Data_Science_em_Producao/Model/Parameter/competition_distance_scaler.pkl', 'rb'))
        self.competition_time_month_scaler    = pickle.load(open('/Users/herna/repos/Data_Science_em_Producao/Model/Parameter/competition_time_month_scaler.pkl', 'rb'))
        self.promo_time_week_scaler           = pickle.load(open('/Users/herna/repos/Data_Science_em_Producao/Model/Parameter/promo_time_week_scaler.pkl', 'rb'))
        self.year_scaler                      = pickle.load(open('/Users/herna/repos/Data_Science_em_Producao/Model/Parameter/year_scaler.pkl', 'rb'))
        self.store_type_encoding              = pickle.load(open('/Users/herna/repos/Data_Science_em_Producao/Model/Parameter/store_type_encoding.pkl', 'rb'))
    ...
    def data_preparation(self, df5, ft):
        ...
        df5['store_type'] = self.store_type.encoding.fit_transform(df5['store_type'])
